...
```bash
DATABASE_URL="postgresql://postgres.mzowcdikituelbzxuvvd:Activate101!@aws-1-us-west-1.pooler.supabase.com:5432/postgres" npx prisma db push --accept-data-loss
```
