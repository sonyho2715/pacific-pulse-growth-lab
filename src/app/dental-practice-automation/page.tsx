      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Link href="/pricing" className="p-6 border border-slate-200 rounded-xl hover:border-blue-500 hover:shadow-lg transition group">
              <h3 className="font-bold text-slate-900 mb-2 group-hover:text-blue-600">View All Pricing Plans</h3>
            ...
            <Link href="/comparison" className="p-6 border border-slate-200 rounded-xl hover:border-blue-500 hover:shadow-lg transition group">
              <h3 className="font-bold text-slate-900 mb-2 group-hover:text-blue-600">Compare Us to Competitors</h3>
